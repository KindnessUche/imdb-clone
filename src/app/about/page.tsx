  ...
  return (
    <div className="max-w-6xl mx-auto p-3 space-y-4 ">
      ...
      <p>
        ...
        enthusiasts who have come up together to create a one-stop destination
        for all your movie-related needs.
      </p>
      <p>
      ...
      <p>
        ...
        looking for ways to improve and enhance the user experience of our
